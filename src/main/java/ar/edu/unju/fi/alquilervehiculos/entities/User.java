...
public class User {
    ...
    public User(Integer id, String username, String password, String name, String lastname, String dni, String email, String phoneNumber, City city, String address, Role role, byte[] photo) {
        this.id = id;
